...
for iter=1:10
    ...
    rdim = 50;
    fname = ['../results/result_jaffe_by_expression_nmf_mse_svm_50_2.mat'];
    showflag = 0;
    tol = 0.00001
    stopconv = 30
    timelimit = 100
    maxiter = 5000
    [W,H,objhistory,iter,elapsed] = nmfmsenew( V, rdim, fname, showflag, stopconv, tol, timelimit, maxiter);
...
fresult = ['../results/result_jaffe_by_expression_nmf_mse_svm_54_classify_2.mat'];
fprintf('Saving...');
