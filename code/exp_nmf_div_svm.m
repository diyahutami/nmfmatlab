...
for iter=1:10
    ...
    rdim = 25;
    fname = ['../results/result_allaml_nmf_div_svm_25.mat'];
    showflag = 0;
    tol = 0.00001
    stopconv = 30
    timelimit = 100
    maxiter = 5000
    [W,H,objhistory,iter,elapsed] = nmfdivnew( V, rdim, fname, showflag, stopconv, tol, timelimit, maxiter);
...
fresult = ['../results/result_allaml_nmf_div_svm_25_classify.mat'];
fprintf('Saving...');
